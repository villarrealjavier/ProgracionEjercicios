...
regalo=int(input("Introduce el regalo de juan en euros: "))
suma=int(input("Introduzca la cantidad quequiere incrementar: "))
while edad<0:
    edad=int(input("Error.Introduce una edad: ")) #En caso de fallo vuelve a pedir la edad
acumulador=suma

for i in range (1,edad):
    regalo=regalo+acumulador
    acumulador+=suma
print("Juan recibió a la edad de ", edad, "años", regalo,"euros.")